    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="text-center">
        ...
        <ul className="space-y-2">
          ...
          <li>
            <Link to="/get-involved/become-player" className="text-gray-400 hover:text-indigo-300 transition duration-200">
              Get Involved
            </Link>
          </li>
          <li>
      ...
      <div className="text-center md:text-right">
        ...
        <p className="text-gray-400">
          Contact: <a href="mailto:info@lacrosseindia.org" className="hover:text-indigo-300">[info@lacrosseindia.org]</a>
        </p>
        <p className="text-gray-400 mt-2">© 2025 Lacrosse India. All rights reserved.</p>
        <p className="text-gray-500 text-sm mt-2">
          [Replace contact email and social media links with actual Lacrosse India details]
        </p>
      </div>
    </div>
  </div>
